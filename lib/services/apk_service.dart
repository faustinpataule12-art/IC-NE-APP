...
class ApkService {
  static const MethodChannel _signerChannel = MethodChannel('com.nps.icone_app/signer');
  ...
  Future<String> _signApk(String unsignedPath, Directory workDir) async {
    ...
    final result = await _signerChannel.invokeMethod<String>('signApk', {
      'inputPath': unsignedPath,
      'outputPath': signedPath,
    });

    if (result == null) {
      throw Exception('La signature native de l\'APK a échoué.');
    }
